...
| Skills      | Projects                                             |
|-------------|------------------------------------------------------|
| **Excel Functions:**<br><span style="font-size: 16px;">Pivot Tables</span><br><span style="font-size: 12px; opacity: 0.6;">VBA Scripting</span> | <ul><li>Project 1</li><li>Project 2</li></ul> |
